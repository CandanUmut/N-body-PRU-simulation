...
# Re-create project directory and main.py content after environment reset
project_dir = "/mnt/data/n_body_pru"
os.makedirs(project_dir, exist_ok=True)

# Save the main.py again
...
# =====================================================
# 🌌 N-Body PRU Simulation - Relational Universe Engine
# =====================================================
...
# Visualization: Evolution of Intelligence Metrics
df = pd.DataFrame(history)
df["Time"] = np.arange(TIME_STEPS)

df.plot(x="Time", y=["mean_resonance", "mean_truth", "light_ratio", "node_count"], figsize=(12, 6),
        title="PRU Intelligence Graph - Conscious N-Body Simulation")
